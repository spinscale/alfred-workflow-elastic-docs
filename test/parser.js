...
describe('parser', () => {
  ...
  it('should parse products', (done) => {
    ...
    expect(parser.parse('w foo').section).to.equal('Learn/Docs/Watcher/Reference/6.1')
    expect(parser.parse('e foo').section).to.equal('Learn/Docs/Elasticsearch/Reference/6.1')
    expect(parser.parse('esp foo').section).to.equal('Learn/Docs/Elasticsearch/Plugins/Reference/6.1')
    done()
  })
